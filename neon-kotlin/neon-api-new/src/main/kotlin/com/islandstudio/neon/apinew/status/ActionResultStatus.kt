...
sealed class ActionResultStatus {
    ...
    data class PlayerRoleNotAssigned(override val message: String = "Player has no role assigned!")
        : ActionResultStatus()

    data class FailedToGetData(override val message: String = "Failed to get data")
        : ActionResultStatus()
}