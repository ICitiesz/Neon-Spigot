...
enum class FolderList(val folder: File) {
    ...
    /* Stable */
    MODE_FOLDER(File(NFile.getDataFolder(), "${Handler.majorVersion}${File.separator}${Handler.serverRunningMode.value}")),
    ...
    private object Handler: IComponentInjector {
        ...
        val majorVersion = appContext.serverMajorVersion
    }
}