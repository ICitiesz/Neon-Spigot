...
enum class Smeltable(val input: Material?, val result: Material?) {
    ...
    LIGHT_GRAY_GLAZED_TERRACOTTA(Material.getMaterial("LIGHT_GRAY_TERRACOTTA"), Material.getMaterial("LIGHT_GRAY_GLAZED_TERRACOTTA")),
